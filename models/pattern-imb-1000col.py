...
amp = 1 # Amplitude
sample = 50000  # For 50 cycles with 1000 data points each
...
# -------------------------------------------------------------------
# Step 3  Make dataset X_2D(100,1000) and y_1D(100) # Features and labels
# -------------------------------------------------------------------
# New merged signal
...
X_2D = X_1D.reshape(100, 1000)  # Change 1000 data points to 100 rows and 10 columns
