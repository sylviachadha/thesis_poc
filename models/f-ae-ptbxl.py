...
mergedDf = pd.DataFrame()
mergedDf["predicted_train"] = pred_transpose_df[10]
mergedDf["actual_train"] = train_X_transpose_df[10]
mergedDf.plot()
plt.show()

mergedDf = pd.DataFrame()
mergedDf["predicted_train"] = pred_transpose_df[4083]
mergedDf["actual_train"] = train_X_transpose_df[4083]
mergedDf.plot()
plt.show()

mergedDf = pd.DataFrame()
mergedDf["predicted_train"] = pred_transpose_df[7700]
mergedDf["actual_train"] = train_X_transpose_df[7700]
mergedDf.plot()
plt.show()

mergedDf = pd.DataFrame()
mergedDf["predicted_train"] = pred_transpose_df[8000]
mergedDf["actual_train"] = train_X_transpose_df[8000]
mergedDf.plot()
plt.show()
...
plt.show()
train_X_transpose_df[0].plot()
plt.show()

# # P8170 predited and actual
# pred_transpose_df[8169].plot()
# plt.show()
# train_X_transpose_df[8169].plot()
# plt.show()
...
mergedDf_test = pd.DataFrame()
mergedDf_test["predicted_test"] = pred_test_transpose_df[958]
mergedDf_test["actual_test"] = test_X_transpose_df[958]
mergedDf_test.plot()
plt.show()

mergedDf_test = pd.DataFrame()
mergedDf_test["predicted_test"] = pred_test_transpose_df[950]
mergedDf_test["actual_test"] = test_X_transpose_df[950]
mergedDf_test.plot()
plt.show()

mergedDf_test = pd.DataFrame()
mergedDf_test["predicted_test"] = pred_test_transpose_df[945]
mergedDf_test["actual_test"] = test_X_transpose_df[945]
mergedDf_test.plot()
plt.show()
