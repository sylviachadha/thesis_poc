...
# Normal and LVH in desired row*col form and then apply Random Forest
...
# ------------------------------------------------------#
# PART E - Step 13-14   Apply Random Forest Algorithm
# ------------------------------------------------------#
...
# Random Forest model with Lead V5

# Step 13 - Random Forest declare and fit on train data
# -----------------------------------------------------------------------#
...
clf.fit(df_train, y_train_short_num)
...
plot_confusion_matrix(clf, df_test, y_test_short_num)
plt.show()
