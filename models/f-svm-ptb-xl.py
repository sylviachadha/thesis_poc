...
# Normal and LVH in desired row*col form and then apply SVM (Basic)
...
# ------------------------------------------------------#
# PART E - Step 13-14   Apply SVC (Basic) Algorithm
# ------------------------------------------------------#
...
# Step 13 - SVC declare and fit on train data
# -----------------------------------------------------------------------#
...
svc.fit(df_train, y_train_short_num)
...
plot_confusion_matrix(svc, df_test, y_test_short_num)
plt.show()
