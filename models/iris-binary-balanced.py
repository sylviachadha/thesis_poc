...
# EVALUATE DIFFERENT ALGORITHMS ON BALANCED BINARY LABELLED DATASET
#---------------------------------------------------------------------
...
# Delete all occurrences of 2 from the numpy array
y_binary = y[y != 2]
print("Filtered Target", y_binary)
print("Length of Filtered Target", len(y_binary))

# summarize class distribution
counter = Counter(y_binary)
print(counter)

# Also need to delete corresponding X values to virginica label
# which is the last 50 rows of data

n = 50
X_binary = X[:-n, :]
print("Filtered data", X_binary)
print("Length of Filtered Data", len(X_binary))


# STEP 3 - Split into Train & Test to feed to ML Algorithm
#----------------------------------------------------------
# Check Shape of data and target/label
print("Shape of data", X_binary.shape)
print("Shape of label", y_binary.shape)

# Split into Train and Test

from sklearn.model_selection import train_test_split
X_train, X_test, y_train, y_test = train_test_split(X_binary, y_binary, test_size=0.2, random_state=4,stratify=y_binary)
